...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem(WPI_TalonFactory talonFactory, JoystickFactory joystickFactory) { //Should implement joystick factory
    ...
    insanityFactor = 1;
    sensitivity = 1;
    //The NetworkTableEntry for the Insanity factor
    insanityFactorEntry = OIConstants.kTab.add("insanityFactor", insanityFactor)
  ...
  public void periodic() {
    insanityFactor = insanityFactorEntry.getDouble();
  }

  public void arcadeDrive() {
    robotDrive.arcadeDrive(leftJoystick.getY() * insanityFactor, rightJoystick.getzRotation() * sensitivity);
  }
