...
/**
 * This class is for the Ball Elevator Subsystem
 * 
...
public class ElevatorSubsystem extends SubsystemBase {
	...
	public ElevatorSubsystem(Factory factory) {
		...
		backMagazine = factory.createTalon(ElevatorConstants.backMagazine);

		// Front wheel for ball intake
		frontMagazine = factory.createTalon(ElevatorConstants.frontMagazine);
