...
# this is partially successful in ishan's Ubuntu 20.0.4 VM (with opencv and cscore installed) - it often drops frames and throws errors, but it "works"
...
def main():
    ...
    camera.setVideoMode(cs.VideoMode.PixelFormat.kYUYV, 320, 240, 15)
